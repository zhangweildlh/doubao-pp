// Doubao-pp sidePanel 常量（P3 同构上游 entrypoints/sidepanel/constants.ts）
//
// 与上游逐字同构，仅 import 路径改指 Doubao 的 core/types 与 core/i18n。
// MEMORY_TYPE_CONFIG / MEMORY_TYPE_MAP 供 MemoryCard / MemoryForm 渲染类型标签，
// SVG_PATHS 供各卡片复用图标路径（star/plus/edit/trash 等）。
